...
#include "CustomChannelRayCastSemanticLidar.generated.h"

/// A ray-cast based Lidar sensor.
UCLASS()
class CARLA_API ACustomChannelRayCastSemanticLidar : public ASensor
{
  GENERATED_BODY()
...
public:
  ...
  ACustomChannelRayCastSemanticLidar(const FObjectInitializer &ObjectInitializer);
